...
We see the progression of training, as successful students mostly focus on familiarisation and preparation for flights (through exercises 1-5) for the first couple of days, and shift to slightly more advanced training with maneuvering and controls (through exercises 6-10) in the next few days. 
From Day 11 onwards, we observe that exercises 16, 17, 18, 30 are practiced often and continue to be practised throughout the training. This is indicated by the medium blue color that dominates a large area of the graph. 
